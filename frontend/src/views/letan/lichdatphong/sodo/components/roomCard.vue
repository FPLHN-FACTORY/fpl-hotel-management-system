...
import type { SoDoPhongResponse, TrangThaiVeSinh } from '@/service/api/letan/lichdatphong/sodophong'
import { updateTrangThaiVeSinh } from '@/service/api/letan/lichdatphong/sodophong'
