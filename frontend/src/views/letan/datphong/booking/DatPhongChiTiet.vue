...
import type { ChonLoaiPhong, PhongDatResponse, TimKhachHangResponse } from '@/service/api/letan/booking'
import { createDatPhong, getPhongTheoLoai, searchKhachHang } from '@/service/api/letan/booking'
