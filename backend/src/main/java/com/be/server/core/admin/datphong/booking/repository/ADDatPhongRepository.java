...
public interface ADDatPhongRepository extends PhieuDatPhongRepository {
...
""")
    boolean isRoomBookedInPeriod(
            @Param("idPhong") String idPhong,
            @Param("ngayNhan") Long ngayNhan,
            @Param("ngayTra") Long ngayTra
    );
